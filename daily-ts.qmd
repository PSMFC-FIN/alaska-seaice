...
baseline_df$upper_extent <- ifelse(baseline_df$seaice_extent_mean + baseline_df$seaice_extent_std <= total_area, baseline_df$seaice_extent_mean + baseline_df$seaice_extent_std, total_area)
...
fig_bs <- plot_ly(baseline_df, x = ~month_day, y = ~upper_extent, type = 'scatter', 
  ...
  # Lower extent 
        add_trace(y = ~lower_extent, type = 'scatter', mode = 'lines',
                  ...
                  showlegend = TRUE, name = 'Mean +/- 1 SD')   %>%
  # Baseline
