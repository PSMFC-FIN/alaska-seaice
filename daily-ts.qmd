...
page-layout: full
---
SUNNY - Can the index on the left (and order of plots when scrolling down) go: Eastern BS, southern, northern, Arctic?  (so southern->arctic goes south->north)
...
SUNNY - should we include a legend for the SD band below each plot?
...
SUNNY - should the max SD band be capped at the toal area, similar to how the minimum is set at 0 km2? Same question for Alaskan Arctic plot
