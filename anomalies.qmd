...
Data Source: NOAA/NSIDC Sea Ice Concentration NSIDC Climate Data Record V4 and Near-Real-Time V2, Arctic <br/> Statistics/Figure Source : NOAA CoastWatch PolarWatch
...
-   Baseline daily extent time series (1991-2020) [Data](data/bs_extent_EasternBering.csv) - [Metadata](data/bs_extent_README.md)
-   Near-real-time daily extent of two recent years [Data](data/nrt_extent_EasternBering.csv) - [Metadata](data/nrt_extent_README.md)
-   Annual mean extent time series (1985-2024) [Data](data/annualized_extent_EasternBering.csv) - [Metadata](data/annualized_extent_README.md)\
